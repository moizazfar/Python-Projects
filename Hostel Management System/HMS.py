...
file_names = ["inouttime.txt", "leave_applications.txt", "room_info_boys.txt",
              "room_info_girls.txt", "student_info.txt", "room_info_others.txt", "visitor_info.txt"]
...
heading = Label(base, text="HOSTEL MANAGEMENT SYSTEM", font=(
    "Arial 30 bold"), bg="lightseagreen", fg="white", padx=490, pady=20)
heading.pack()
...
def main():
    ...
    def add_stud():
        ...
        first_name = Label(base, text="First Name", font=(
            "Arial 15 bold"), bg='silver', fg="black")
        ...
        gender = Label(base, text="Gender", font=(
            "Arial 15 bold"), bg="silver", fg="black")
        ...
        def available_roome():
            ...
            x = "    Room No.                       |                                 Beds"
            room = Label(base, text=x, font=("Arial 15 bold"),
            ...
            if count == 1:
                ...
                x = Label(base, text=y, font=("Arial", 40),
                          bg="dark slate grey", fg="white")
                ...
                flag = 1
                for i in rooms:
                    r_no = Label(base, text=i[0], font=(
                        "Arial", 15), bg="silver", fg="black")
                    r_no.place(x=x1co, y=y1co)
                    y = i[1] + "   " + i[2] + "   " + i[3]
                    r_bk_no = Label(base, text=y, font=(
                        "Arial", 15), bg="silver", fg="black")
                ...
                if b == bed1:
                    for oneline in fdata_ls:
                        if oneline.startswith(rom + ",") and oneline.__contains__(","+bed1):
                            # write date
                            new_oneline = oneline.replace(
                                ","+bed1+",", "," + c + ",")
                            new_oneline2 = new_oneline.replace(
                                ",NOT,", "," + rdate + ",")
            ...
            add_student = Button(base, text="Add Student", font=(
                "Arial 20 bold"), bg="white", fg="black", command=student)
            add_student.place(x=1040, y=700)

        c1 = IntVar()
        a = Radiobutton(base, text="Male", bg="silver", fg="black", font=(
            "Arial 15 bold"), variable=c1, value=1, command=selected)
        b = Radiobutton(base, text="Female", bg="silver", fg="black", font=(
            "Arial 15 bold"), variable=c1, value=2, command=selected)
        c = Radiobutton(base, text="Other", bg="silver", fg="black", font=(
            "Arial 15 bold"), variable=c1, value=0, command=selected)
        a.place(x=490, y=580)
        b.place(x=580, y=580)
        c.place(x=680, y=580)
        continu = Button(base, text="Continue", font=(
            "Arial 15 bold"), bg="white", command=available_roome)
    ...
    def add_room():
        ...
        n_rm_n = Label(base, text="New Room No.", font=(
            "Arial 20 bold"), bg="silver", fg="black")
        ...
        ad_rm_btn = Button(base, text="Add Room", font=(
            "Arial 20 bold"), bg="white", fg="black", command=add)
    ...
    def in_out_time():
        ...
        out_time = Label(base, text="Enter ID", font=(
            "Arial 20 bold"), bg="silver", fg="black")
        ...
        purpose = Label(base, text="Purpose", font=(
            "Arial 20 bold"), bg="silver", fg="black")
        ...
        def save1():
            ...
            f1.write(Id + "," + pur1 + "," + t + "," +
                     "OUTTIME" + "," + "REMARK" + "\n")
            f1.close()
            done = Label(base, text="Successfull...!", font=(
                "Arial 20 bold"), bg="silver", fg="black")
            done.place(x=1200, y=220)

        save1 = Button(base, text="Save", font=("Arial 20 bold"),
                       bg="white", fg="black", command=save1)
        ...
        in_time = Label(base, text="Enter ID", font=(
            "Arial 20 bold"), bg="silver", fg="black")
        ...
        ot_entry = Label(base, text="Outtime Entry", font=(
            "Arial 20 bold"), bg="silver", fg="black")
        ...
        def search_outtime():
            ...
            for oneline in fdata_ls:
                if oneline.startswith(s_id + ",") and oneline.__contains__(",OUTTIME,"):
                    ...
                    tv = StringVar()
                    tv.set(y[2] + "     " + y[3])
                    ot = Entry(base, width=20, textvariable=tv,
                               font=("Arial 20 bold"))
        ...
        def save2():
            ...
            for oneline in fdata_ls:
                if oneline.startswith(s_id + ",") and oneline.__contains__(",OUTTIME,"):
                    ...
                    fobj.write(oneline)
            if count == 2:
                done = Label(base, text="Successful...!", font=(
                    "Arial 20 bold"), bg="silver", fg="black")
        ...
        sear_ot = Button(base, text="Search Outtime", font=(
            "Arial 18 bold"), bg="white", command=search_outtime)
    ...
    def visitor():
        ...
        def search():
            ...
            reset_btn = Button(base, text="Reset", font=(
                "Arial 20 bold"), command=reset)
            ...
            for oneline in fdata_ls:
                if oneline.__contains__("," + s_n + ","):
                    ...
                    tv = StringVar()
                    tv.set(y[11])
                    ot_name = Label(base, text="Room No.", font=(
                        "Arial 20 bold"), bg="silver")
                    ot_name.place(x=1020, y=400)
                    ot = Entry(base, width=15, textvariable=tv,
                               font=("Arial 20 bold"), justify=CENTER)
                    ot.place(x=1250, y=400)
                    add_btn = Button(base, text="Add Visitor", font=(
                        "Arial 20 bold"), command=add_visitor)
        ...
        ser_btn = Button(base, text="Search", font=(
            "Arial 20 bold"), command=search)
    ...
    def view_info():
        ...
        def all_girl_info():
            ...
            h2 = Label(base, text=h, font=("Arial 20 bold"),
                       bg="dark orange", fg="white")
            ...
            for i in students:
                ...
                c = 0
                while c <= 2:
                    label = Label(base, text=y[0], font=(
                        "Arial 15 bold"), bg="silver", fg="black")
                    label.place(x=x1co, y=y1co)
                    label2 = Label(base, text=y[1], font=(
                        "Arial 15 bold"), bg="silver", fg='black')
                    label2.place(x=x2co, y=y1co)
                    label3 = Label(base, text=y[2], font=(
                        'Arial 15 bold'), bg="silver", fg='black')
                    label3.place(x=x3co, y=y1co)
                    label4 = Label(base, text=y[3], font=(
                        "Arial 15 bold"), bg="silver", fg="black")
        ...
        def room_wise():
            canvas = Canvas(base, bg='silver', height=675, width=810)
            canvas.place(x=715, y=105)
            l1 = Label(base, text="Enter Room No.", font=(
                "Arial 20 bold"), bg="silver", fg="black")
            ...
            search_btn = Button(base, text="Search", font=(
                "Arial 20 bold"), command=search)
        ...
        stud_room_wise = Button(base, text="Room Info", font=(
            "Arial 20 bold"), padx=60, pady=5, command=room_wise)
    ...
    def leave_application():
        ...
        return_date = Label(base, text="Return Date",
                            bg="silver", font=("Arial 20 bold"), fg="black")
        return_date.place(x=400, y=500)
        x = Label(base, text="(YEAR-DD-MM)",
                  font=("Arial 15 bold"), bg="silver", fg="black")
        ...
        def leave_info():
            ...
            fopen.write(i + "," + n + "," + r + "," + m + "," +
                        reas + "," + current_date + "," + rdate + "," + "\n")
            fopen.close()
            success = Label(base, text="Submit Successfully..!", font=(
                "Arial 20 bold"), fg="green", bg="white")
            success.place(x=700, y=700)

        submit = Button(base, text="Submit", font=(
            "Arial 20 bold"), fg="black", command=leave_info)
        submit.place(x=700, y=600)

    add_std_btn = Button(base, text="Add Student", font=(
        "Arial 20 bold"), padx=15, bg="white", command=add_stud)
    add_std_btn.place(x=50, y=150)

    add_new_room = Button(base, text="Add New Room", font=(
        "Arial 20 bold"), bg="white", command=add_room)
    add_new_room.place(x=50, y=250)

    in_ot_time = Button(base, text="In And Outtime", font=(
        "Arial 20 bold"), bg="white", command=in_out_time)
    in_ot_time.place(x=50, y=350)

    visitor = Button(base, text="Visitor", font=(
        "Arial 20 bold"), bg="white", padx=55, command=visitor)
    visitor.place(x=50, y=450)

    view_info = Button(base, text="View Information", font=(
        "Arial 18 bold"), bg="white", command=view_info)
    view_info.place(x=50, y=535)

    leave_application = Button(base, text="Leave Application", font=(
        "Arial 18 bold"), bg="white", command=leave_application)
    leave_application.place(x=50, y=620)

    exit = Button(base, text="EXIT", font=("Arial 18 bold"),
                  bg="white", padx=70, command=quit)
    exit.place(x=50, y=700)


username = Label(base, text="Username", font=(
    "Arial 25 bold"), bg="silver", fg="black")
username.place(x=470, y=240)
user_entry = Entry(base, width=17, font=("Arial 20"))
user_entry.place(x=650, y=245)
user_entry.focus()

password = Label(base, text="Password", font=(
    "Arial 25 bold"), bg="silver", fg="black")
...
def login():
    ...
    if id == "moizazfar" and key == "moiz123":
        main()
    else:
        user_entry.focus()
        user_entry.delete(0, END)
        pass_entry.delete(0, END)
        fail = Label(base, text="Wrong Username Or Password...!",
                     font=("Arial 30 bold"), bg="silver", fg="red")
